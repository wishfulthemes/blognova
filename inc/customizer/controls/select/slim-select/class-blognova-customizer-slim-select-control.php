...
if ( ! class_exists( 'Blognova_Customizer_Slim_Select_Control' ) ) {

	/**
	 * Class for slim-select control in customizer.
	 */
	class Blognova_Customizer_Slim_Select_Control extends WP_Customize_Control {
		 ...
		 * @var    string
		 */
		public $type = 'blognova_slim_select';
		...
		public function enqueue() {
			$path   = esc_url( get_template_directory_uri() . '/inc/customizer/controls/select/slim-select' );
			$handle = 'blognova-customizer-slim-select-control';
